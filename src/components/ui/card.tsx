...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("bg-card text-card-foreground border !rounded-3xl flex flex-col gap-6 overflow-hidden py-4 text-sm data-[size=sm]:gap-4 data-[size=sm]:py-4", className)}
      {...props}
    />
  )
}
