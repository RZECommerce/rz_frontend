...
import { OvertimeHeader } from "@/components/hris/overtime/overtime-header";
import { UnifiedOvertimeStats } from "@/components/hris/overtime/unified-overtime-stats";
import { UnifiedOvertimeTable } from "@/components/hris/overtime/unified-overtime-table";
...
export const Route = createFileRoute("/hris/overtime-logs")({
  beforeLoad: requireAuth(),
  component: OvertimeLogsPage,
});

function OvertimeLogsPage() {
  ...
  return (
    <DashboardLayout>
      ...
      >
        <OvertimeHeader onExport={handleExport} />
        <UnifiedOvertimeStats filters={filters} />
        <UnifiedOvertimeTable filters={filters} onFiltersChange={setFilters} />
      </main>
    </DashboardLayout>
  );
}
