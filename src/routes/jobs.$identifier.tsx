...
function PublicJobApplicationPage() {
  ...
  const {
    ...
    queryKey: ["public-job-posting", identifier],
    queryFn: () => recruitmentService.getPublicJobPosting(identifier),
    retry: false,
  });

  const submitApplicationMutation = useMutation({
    mutationFn: (payload: PublicJobApplicationDto) =>
      recruitmentService.applyToJobPosting(identifier, payload),
    onSuccess: () => {
      setIsSubmitted(true);
      setFormError("");
    },
